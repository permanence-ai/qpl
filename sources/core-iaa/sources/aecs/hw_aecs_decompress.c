...
static void pack_cam(uint8_t *out_cam_p1, uint8_t *out_cam_p2, uint16_t *in_cam) {
    ...
    tmp_cam_ptr[0] =
        (((uint64_t)(in_cam[0] & 0xF)) << 0) |
        (((uint64_t)(in_cam[1] & 0x1F)) << 4) |
        (((uint64_t)(in_cam[2] & 0x3F)) << 9) |
        (((uint64_t)(in_cam[3] & 0x3F)) << 15) |
        (((uint64_t)(in_cam[4] & 0x7F)) << 21) |
        (((uint64_t)(in_cam[5] & 0x7F)) << 28) |
        (((uint64_t)(in_cam[6] & 0x7F)) << 35) |
        (((uint64_t)(in_cam[7] & 0x7F)) << 42) |
        (((uint64_t)(in_cam[8] & 0xFF)) << 49) |
        (((uint64_t)(in_cam[9] & 0xFF)) << 57);
    tmp_cam_ptr[1] =
        (((uint64_t)(in_cam[9] & 0xFF)) >> 7) |
        (((uint64_t)(in_cam[10] & 0xFF)) << 1) |
        (((uint64_t)(in_cam[11] & 0xFF)) << 9) |
        (((uint64_t)(in_cam[12] & 0xFF)) << 17) |
        (((uint64_t)(in_cam[13] & 0xFF)) << 25) |
        (((uint64_t)(in_cam[14] & 0xFF)) << 33) |
        (((uint64_t)(in_cam[15] & 0xFF)) << 41) |
        (((uint64_t)(in_cam[16] & 0x1FF)) << 49) |
        (((uint64_t)(in_cam[17] & 0x1FF)) << 58);
    tmp_cam_ptr[2] =
        (((uint64_t)(in_cam[17] & 0x1FF)) >> 6) |
        (((uint64_t)(in_cam[18] & 0x1FF)) << 3) |
        (((uint64_t)(in_cam[19] & 0x1FF)) << 12) |
        (((uint64_t)(in_cam[20] & 0x1FF)) << 21) |
        (((uint64_t)(in_cam[21] & 0x1FF)) << 30) |
        (((uint64_t)(in_cam[22] & 0x1FF)) << 39) |
        (((uint64_t)(in_cam[23] & 0x1FF)) << 48) |
        (((uint64_t)(in_cam[24] & 0x1FF)) << 57);
    tmp_cam_ptr[3] =
        (((uint64_t)(in_cam[24] & 0x1FF)) >> 7) |
        (((uint64_t)(in_cam[25] & 0x1FF)) << 2) |
        (((uint64_t)(in_cam[26] & 0x1FF)) << 11) |
        (((uint64_t)(in_cam[27] & 0x1FF)) << 20) |
        (((uint64_t)(in_cam[28] & 0x1FF)) << 29) |
        (((uint64_t)(in_cam[29] & 0x1FF)) << 38) |
        (((uint64_t)(in_cam[30] & 0x1FF)) << 47) |
        (((uint64_t)(in_cam[31] & 0x1FF)) << 56);
    tmp_cam_ptr[4] =
        (((uint64_t)(in_cam[31] & 0x1FF)) >> 8) |
        (((uint64_t)(in_cam[32] & 0x3FF)) << 1) |
        (((uint64_t)(in_cam[33] & 0x3FF)) << 11) |
        (((uint64_t)(in_cam[34] & 0x3FF)) << 21) |
        (((uint64_t)(in_cam[35] & 0x3FF)) << 31) |
        (((uint64_t)(in_cam[36] & 0x3FF)) << 41) |
        (((uint64_t)(in_cam[37] & 0x3FF)) << 51) |
        (((uint64_t)(in_cam[38] & 0x3FF)) << 61);
    tmp_cam_ptr[5] =
        (((uint64_t)(in_cam[38] & 0x3FF)) >> 3) |
        (((uint64_t)(in_cam[39] & 0x3FF)) << 7) |
        (((uint64_t)(in_cam[40] & 0x3FF)) << 17) |
        (((uint64_t)(in_cam[41] & 0x3FF)) << 27) |
        (((uint64_t)(in_cam[42] & 0x3FF)) << 37) |
        (((uint64_t)(in_cam[43] & 0x3FF)) << 47) |
        (((uint64_t)(in_cam[44] & 0x3FF)) << 57);
    tmp_cam_ptr[6] =
        (((uint64_t)(in_cam[44] & 0x3FF)) >> 7) |
        (((uint64_t)(in_cam[45] & 0x3FF)) << 3) |
        (((uint64_t)(in_cam[46] & 0x3FF)) << 13) |
        (((uint64_t)(in_cam[47] & 0x3FF)) << 23) |
        (((uint64_t)(in_cam[48] & 0x3FF)) << 33) |
        (((uint64_t)(in_cam[49] & 0x3FF)) << 43) |
        (((uint64_t)(in_cam[50] & 0x3FF)) << 53) |
        (((uint64_t)(in_cam[51] & 0x3FF)) << 63);
    tmp_cam_ptr[7] =
        (((uint64_t)(in_cam[51] & 0x3FF)) >> 1) |
        (((uint64_t)(in_cam[52] & 0x3FF)) << 9) |
        (((uint64_t)(in_cam[53] & 0x3FF)) << 19) |
        (((uint64_t)(in_cam[54] & 0x3FF)) << 29) |
        (((uint64_t)(in_cam[55] & 0x3FF)) << 39) |
        (((uint64_t)(in_cam[56] & 0x3FF)) << 49) |
        (((uint64_t)(in_cam[57] & 0x3FF)) << 59);
    tmp_cam_ptr[8] =
        (((uint64_t)(in_cam[57] & 0x3FF)) >> 5) |
        (((uint64_t)(in_cam[58] & 0x3FF)) << 5) |
        (((uint64_t)(in_cam[59] & 0x3FF)) << 15) |
        (((uint64_t)(in_cam[60] & 0x3FF)) << 25) |
        (((uint64_t)(in_cam[61] & 0x3FF)) << 35) |
        (((uint64_t)(in_cam[62] & 0x3FF)) << 45) |
        (((uint64_t)(in_cam[63] & 0x3FF)) << 55);
    tmp_cam_ptr[9] =
        (((uint64_t)(in_cam[63] & 0x3FF)) >> 9) |
        (((uint64_t)(in_cam[64] & 0x7FF)) << 1) |
        (((uint64_t)(in_cam[65] & 0x7FF)) << 12) |
        (((uint64_t)(in_cam[66] & 0x7FF)) << 23) |
        (((uint64_t)(in_cam[67] & 0x7FF)) << 34) |
        (((uint64_t)(in_cam[68] & 0x7FF)) << 45) |
        (((uint64_t)(in_cam[69] & 0x7FF)) << 56);
    tmp_cam_ptr[10] =
        (((uint64_t)(in_cam[69] & 0x7FF)) >> 8) |
        (((uint64_t)(in_cam[70] & 0x7FF)) << 3) |
        (((uint64_t)(in_cam[71] & 0x7FF)) << 14) |
        (((uint64_t)(in_cam[72] & 0x7FF)) << 25) |
        (((uint64_t)(in_cam[73] & 0x7FF)) << 36) |
        (((uint64_t)(in_cam[74] & 0x7FF)) << 47) |
        (((uint64_t)(in_cam[75] & 0x7FF)) << 58);
    tmp_cam_ptr[11] =
        (((uint64_t)(in_cam[75] & 0x7FF)) >> 6) |
        (((uint64_t)(in_cam[76] & 0x7FF)) << 5) |
        (((uint64_t)(in_cam[77] & 0x7FF)) << 16) |
        (((uint64_t)(in_cam[78] & 0x7FF)) << 27) |
        (((uint64_t)(in_cam[79] & 0x7FF)) << 38) |
        (((uint64_t)(in_cam[80] & 0x7FF)) << 49) |
        (((uint64_t)(in_cam[81] & 0x7FF)) << 60);
    tmp_cam_ptr[12] =
        (((uint64_t)(in_cam[81] & 0x7FF)) >> 4) |
        (((uint64_t)(in_cam[82] & 0x7FF)) << 7) |
        (((uint64_t)(in_cam[83] & 0x7FF)) << 18) |
        (((uint64_t)(in_cam[84] & 0x7FF)) << 29) |
        (((uint64_t)(in_cam[85] & 0x7FF)) << 40) |
        (((uint64_t)(in_cam[86] & 0x7FF)) << 51) |
        (((uint64_t)(in_cam[87] & 0x7FF)) << 62);
    tmp_cam_ptr[13] =
        (((uint64_t)(in_cam[87] & 0x7FF)) >> 2) |
        (((uint64_t)(in_cam[88] & 0x7FF)) << 9) |
        (((uint64_t)(in_cam[89] & 0x7FF)) << 20) |
        (((uint64_t)(in_cam[90] & 0x7FF)) << 31) |
        (((uint64_t)(in_cam[91] & 0x7FF)) << 42) |
        (((uint64_t)(in_cam[92] & 0x7FF)) << 53);
    tmp_cam_ptr[14] =
        (((uint64_t)(in_cam[93] & 0x7FF)) << 0) |
        (((uint64_t)(in_cam[94] & 0x7FF)) << 11) |
        (((uint64_t)(in_cam[95] & 0x7FF)) << 22) |
        (((uint64_t)(in_cam[96] & 0x7FF)) << 33) |
        (((uint64_t)(in_cam[97] & 0x7FF)) << 44) |
        (((uint64_t)(in_cam[98] & 0x7FF)) << 55);
    tmp_cam_ptr[15] =
        (((uint64_t)(in_cam[98] & 0x7FF)) >> 9) |
        (((uint64_t)(in_cam[99] & 0x7FF)) << 2) |
        (((uint64_t)(in_cam[100] & 0x7FF)) << 13) |
        (((uint64_t)(in_cam[101] & 0x7FF)) << 24) |
        (((uint64_t)(in_cam[102] & 0x7FF)) << 35) |
        (((uint64_t)(in_cam[103] & 0x7FF)) << 46) |
        (((uint64_t)(in_cam[104] & 0x7FF)) << 57);
    tmp_cam_ptr[16] =
        (((uint64_t)(in_cam[104] & 0x7FF)) >> 7) |
        (((uint64_t)(in_cam[105] & 0x7FF)) << 4) |
        (((uint64_t)(in_cam[106] & 0x7FF)) << 15) |
        (((uint64_t)(in_cam[107] & 0x7FF)) << 26) |
        (((uint64_t)(in_cam[108] & 0x7FF)) << 37) |
        (((uint64_t)(in_cam[109] & 0x7FF)) << 48) |
        (((uint64_t)(in_cam[110] & 0x7FF)) << 59);
    tmp_cam_ptr[17] =
        (((uint64_t)(in_cam[110] & 0x7FF)) >> 5) |
        (((uint64_t)(in_cam[111] & 0x7FF)) << 6) |
        (((uint64_t)(in_cam[112] & 0x7FF)) << 17) |
        (((uint64_t)(in_cam[113] & 0x7FF)) << 28) |
        (((uint64_t)(in_cam[114] & 0x7FF)) << 39) |
        (((uint64_t)(in_cam[115] & 0x7FF)) << 50) |
        (((uint64_t)(in_cam[116] & 0x7FF)) << 61);
    tmp_cam_ptr[18] =
        (((uint64_t)(in_cam[116] & 0x7FF)) >> 3) |
        (((uint64_t)(in_cam[117] & 0x7FF)) << 8) |
        (((uint64_t)(in_cam[118] & 0x7FF)) << 19) |
        (((uint64_t)(in_cam[119] & 0x7FF)) << 30) |
        (((uint64_t)(in_cam[120] & 0x7FF)) << 41) |
        (((uint64_t)(in_cam[121] & 0x7FF)) << 52) |
        (((uint64_t)(in_cam[122] & 0x7FF)) << 63);
    tmp_cam_ptr[19] =
        (((uint64_t)(in_cam[122] & 0x7FF)) >> 1) |
        (((uint64_t)(in_cam[123] & 0x7FF)) << 10) |
        (((uint64_t)(in_cam[124] & 0x7FF)) << 21) |
        (((uint64_t)(in_cam[125] & 0x7FF)) << 32) |
        (((uint64_t)(in_cam[126] & 0x7FF)) << 43) |
        (((uint64_t)(in_cam[127] & 0x7FF)) << 54);
    tmp_cam_ptr[20] =
        (((uint64_t)(in_cam[127] & 0x7FF)) >> 10) |
        (((uint64_t)(in_cam[128] & 0xFFF)) << 1) |
        (((uint64_t)(in_cam[129] & 0xFFF)) << 13) |
        (((uint64_t)(in_cam[130] & 0xFFF)) << 25) |
        (((uint64_t)(in_cam[131] & 0xFFF)) << 37) |
    ...
    for (out = 21, in = 133;
         ...
         out += 3, in += 16) {
        tmp_cam_ptr[out] =
            (((uint64_t)(in_cam[in+0] & 0xFFF)) >> 3) |
            (((uint64_t)(in_cam[in+1] & 0xFFF)) << 9) |
            (((uint64_t)(in_cam[in+2] & 0xFFF)) << 21) |
            (((uint64_t)(in_cam[in+3] & 0xFFF)) << 33) |
            (((uint64_t)(in_cam[in+4] & 0xFFF)) << 45) |
            (((uint64_t)(in_cam[in+5] & 0xFFF)) << 57);
        if (out == 27) {
        ...
        tmp_cam_ptr[out+1] =
            (((uint64_t)(in_cam[in+5] & 0xFFF)) >> 7) |
            (((uint64_t)(in_cam[in+6] & 0xFFF)) << 5) |
            (((uint64_t)(in_cam[in+7] & 0xFFF)) << 17) |
            (((uint64_t)(in_cam[in+8] & 0xFFF)) << 29) |
            (((uint64_t)(in_cam[in+9] & 0xFFF)) << 41) |
            (((uint64_t)(in_cam[in+10] & 0xFFF)) << 53);
        tmp_cam_ptr[out+2] =
            (((uint64_t)(in_cam[in+10] & 0xFFF)) >> 11) |
            (((uint64_t)(in_cam[in+11] & 0xFFF)) << 1) |
            (((uint64_t)(in_cam[in+12] & 0xFFF)) << 13) |
            (((uint64_t)(in_cam[in+13] & 0xFFF)) << 25) |
            (((uint64_t)(in_cam[in+14] & 0xFFF)) << 37) |
            (((uint64_t)(in_cam[in+15] & 0xFFF)) << 49) |
            (((uint64_t)(in_cam[in+16] & 0xFFF)) << 61);
    }
    tmp_cam_ptr[42] =
        (((uint64_t)(in_cam[245] & 0xFFF)) >> 3) |
        (((uint64_t)(in_cam[246] & 0xFFF)) << 9) |
        (((uint64_t)(in_cam[247] & 0xFFF)) << 21) |
        (((uint64_t)(in_cam[248] & 0xFFF)) << 33) |
        (((uint64_t)(in_cam[249] & 0xFFF)) << 45) |
        (((uint64_t)(in_cam[250] & 0xFFF)) << 57);
    tmp_cam_ptr[43] =
        (((uint64_t)(in_cam[250] & 0xFFF)) >> 7) |
        (((uint64_t)(in_cam[251] & 0xFFF)) << 5) |
        (((uint64_t)(in_cam[252] & 0xFFF)) << 17) |
        (((uint64_t)(in_cam[253] & 0xFFF)) << 29) |
        (((uint64_t)(in_cam[254] & 0xFFF)) << 41) |
        (((uint64_t)(in_cam[255] & 0xFFF)) << 53);
    tmp_cam_ptr[44] =
        (((uint64_t)(in_cam[255] & 0xFFF)) >> 11) |
        (((uint64_t)(in_cam[256] & 0x1FFF)) << 1) |
        (((uint64_t)(in_cam[257] & 0x1FFF)) << 14) |
        (((uint64_t)(in_cam[258] & 0x1FFF)) << 27) |
        (((uint64_t)(in_cam[259] & 0x1FFF)) << 40) |
        (((uint64_t)(in_cam[260] & 0x1FFF)) << 53);
    tmp_cam_ptr[45] =
        (((uint64_t)(in_cam[260] & 0x1FFF)) >> 11) |
        (((uint64_t)(in_cam[261] & 0x1FFF)) << 2) |
        (((uint64_t)(in_cam[262] & 0x1FFF)) << 15) |
        (((uint64_t)(in_cam[263] & 0x1FFF)) << 28) |
